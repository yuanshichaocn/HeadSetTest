...
namespace StationDemo.Station
{
    ...
    /// 隔音箱 Sound Proof Box
    /// </summary>
    public class SPBStation : Stationbase
    {
        public SPBStation(string strname, int[] axis, string[] axisname, params string[] CameraName) : base(strname, axis, axisname, CameraName)
        {
        }
