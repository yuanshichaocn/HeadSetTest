...
namespace gts
{
    public class mc
    {
        ...
        [DllImport("gts.dll")]
        public static extern short GT_SetCrdFollowLoop(short cardNum, short crd, long loop);
        [DllImport("gts.dll")]
        public static extern short GT_GetCrdFollowLoop(short cardNum, short crd, out long pLoop);
        [DllImport("gts.dll")]
