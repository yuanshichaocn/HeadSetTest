...
namespace Leadshine
{
    public static class LTSMC
    {
       ...
       ***********************************************************************************************************/
        ...
        [DllImport("LTSMC.dll")]
        public static extern short smc_get_card_version(ushort ConnectNo, ref uint CardVersion);	//读取控制卡硬件版本
        [DllImport("LTSMC.dll")]
        public static extern short smc_get_card_soft_version(ushort ConnectNo, ref uint FirmID, ref uint SubFirmID);	//读取控制卡硬件的固件版本
        [DllImport("LTSMC.dll")]
        public static extern short smc_get_card_lib_version(ref uint LibVer);	//读取控制卡动态库版本
        [DllImport("LTSMC.dll")]
        ...
        *************************************/
        ...
        [DllImport("LTSMC.dll")]
        public static extern short smc_trace_start(ushort ConnectNo, ushort[] AxisList);
        [DllImport("LTSMC.dll")]
        ...
        [DllImport("LTSMC.dll")]
        public static extern short nmc_get_total_axes(ushort ConnectNo, ref uint TotalAxis); 	//读取指定卡轴数
        [DllImport("LTSMC.dll")]
        public static extern short nmc_get_total_ionum(ushort ConnectNo, ref ushort TotalIn, ref ushort TotalOut);
        [DllImport("LTSMC.dll")]
        public static extern short nmc_get_total_adcnum(ushort ConnectNo, ref ushort TotalIn, ref ushort TotalOut);
        [DllImport("LTSMC.dll")]
        public static extern short nmc_get_slave_nodes(ushort ConnectNo, ushort PortNum, ushort baudrate, ushort[] NodeID, ref ushort NodeNum);
        [DllImport("LTSMC.dll")]
        public static extern short nmc_clear_errcode(ushort CardNo, ushort axis);
        [DllImport("LTSMC.dll")]
        public static extern short nmc_get_EmergeneyMessege_Nodes(ushort CardNo, ushort PortNum, uint[] NodeMsg, ref ushort MsgNum);
        [DllImport("LTSMC.dll")]
        public static extern short nmc_get_errcode(ushort CardNo, ushort axis, ref ushort errcode);
        [DllImport("LTSMC.dll")]
        ...
        [DllImport("LTSMC.dll")]
        public static extern short nmc_get_node_od(ushort CardNo, ushort PortNum, ushort nodenum, ushort index, ushort subindex, ushort valuelength, ref uint value);
        [DllImport("LTSMC.dll")]
        ...
        [DllImport("LTSMC.dll")]
        public static extern short nmc_set_axis_enable(ushort CardNo, ushort PortNum, ushort nodenum);
        [DllImport("LTSMC.dll")]
        ...
        [DllImport("LTSMC.dll")]
        public static extern short nmc_set_node_od(ushort CardNo, ushort PortNum, ushort nodenum, ushort index, ushort subindex, ushort valuelength, uint value);
        [DllImport("LTSMC.dll")]
        public static extern short nmc_syn_move(ushort CardNo, ushort AxisNum, ushort[] AxisList, int[] Position, ushort[] PosiMode);
        [DllImport("LTSMC.dll")]
        public static extern short nmc_write_outbit(ushort ConnectNo, ushort NodeID, ushort IoBit, ushort IoValue);
        [DllImport("LTSMC.dll")]
        public static extern short nmc_read_outbit(ushort ConnectNo, ushort NodeID, ushort IoBit, ref ushort IoValue);
        [DllImport("LTSMC.dll")]
        public static extern short nmc_read_inbit(ushort ConnectNo, ushort NodeID, ushort IoBit, ref ushort IoValue);
        [DllImport("LTSMC.dll")]
        public static extern short nmc_write_outport(ushort ConnectNo, ushort NodeID, ushort PortNo, int IoValue);
        [DllImport("LTSMC.dll")]
        public static extern short nmc_read_outport(ushort ConnectNo, ushort NodeID, ushort PortNo, ref int IoValue);
        [DllImport("LTSMC.dll")]
        public static extern short nmc_read_inport(ushort ConnectNo, ushort NodeID, ushort PortNo, ref int IoValue);
