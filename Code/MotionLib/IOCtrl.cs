...
namespace MotionIoLib
{
    ...
    public class IOMgr
    {
        ...
        private ILog _loggger = LogManager.GetLogger("IOMgr");
        ...
        private static IOMgr _IOObj = null;
        ...
        private List<IoCtrl> m_listCard = new List<IoCtrl>();
        ...
        private bool[] m_bOldInputState = null;
        private bool[] m_bOldOutputState = null;
        private Dictionary<string, IoDefine> m_ioInput = new Dictionary<string, IoDefine>();
        private Dictionary<string, IoDefine> m_ioOutput = new Dictionary<string, IoDefine>();

        //上次IO状态
        private Dictionary<string, bool> m_ioInputOldState = new Dictionary<string, bool>();

        private Dictionary<string, bool> m_ioOutputOldState = new Dictionary<string, bool>();

        //IO边沿状态
        private Dictionary<string, IoEdgeState> m_ioInputEdgeState = new Dictionary<string, IoEdgeState>();

        private Dictionary<string, IoEdgeState> m_ioOutputEdgeState = new Dictionary<string, IoEdgeState>();
