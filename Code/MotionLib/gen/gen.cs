...
namespace GTN
{
    public class mc
    {
        ...
        [DllImport("gen.dll")]
        public static extern short GT_GetEcatSlaveInfo(short SlaveIndex, out TSlaveInfo pSlaveinfo);
        [DllImport("gen.dll")]
        ...
        [DllImport("gen.dll")]
        public static extern short GTN_GetEcatSlaveInfo(short core, short SlaveIndex, out TSlaveInfo pSlaveinfo);
        [DllImport("gen.dll")]
        ...
        [DllImport("gen.dll")]
        public static extern short GTN_RelateEcatSlaveToMcGpoBit(short core, short gpoIndex, short slaveNo, short slaveType, short ecatDoIndex,short pdoOffset);
    }
}
