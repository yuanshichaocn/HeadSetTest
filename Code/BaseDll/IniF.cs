...
namespace BaseDll
{
    ...
    public class NiceIniWriteAndRead
    {
        ...
        public  bool WriteToIni(string section, string key, string val, string filePath)
        ...
        ConcurrentDictionary<string, ConcurrentDictionary<string, string>> _iniDic;
        public   ConcurrentDictionary<string, ConcurrentDictionary<string,string>> ReadIniFileToDic(string strPath)
        {
            try
            {
               lock( lockobj)
